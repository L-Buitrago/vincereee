...
import SovtreLogo from "./SovtreLogo";
...
const Footer = () => {
  return (
    <footer id="footer" className="relative bg-secondary text-white overflow-hidden">
      {/* Hero Video Background (Visual impact increased) */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 md:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 mb-24">
          <div className="md:col-span-12 lg:col-span-5 space-y-8">
            <Link to="/" className="flex items-center gap-3 group">
              <SovtreLogo className="w-8 h-8 group-hover:scale-110 transition-transform duration-500" />
              <span className="text-3xl font-serif italic tracking-tighter">Sovtre</span>
            </Link>
          ...
          <div className="md:col-span-4 lg:col-span-2 space-y-8">
            ...
            <ul className="space-y-5">
              ...
              <li><Link to="/about" className="text-sm font-bold text-white/70 hover:text-white transition-all flex items-center gap-2 group">A Sovtre <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all" /></Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 pb-12 border-t border-white/5 gap-8">
          <p className="text-[11px] font-black uppercase tracking-[0.3em] text-white/20">© 2026 Sovtre. Todos os direitos reservados.</p>
