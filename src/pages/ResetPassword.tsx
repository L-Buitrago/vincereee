...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A] px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-400/5 blur-[120px] rounded-full translate-y-1/2 -translate-x-1/2" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input 
                ...
                minLength={6}
                placeholder="••••••••"
                className="bg-white/5 border-white/10 text-white h-12 focus:ring-blue-500/50 focus:border-blue-500"
              />
            </div>

            <Button 
              type="submit" 
              className="w-full h-12 bg-blue-600 text-white hover:bg-blue-700 font-bold rounded-xl flex items-center justify-center gap-2 group transition-all duration-300 shadow-lg shadow-blue-600/10" 
              disabled={loading}
            >
              {loading ? (
