    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24 md:px-8 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          <p>
            A Sovtre ("nós", "nosso") valoriza a privacidade dos seus usuários ("você", "seu"). Esta Política de Privacidade explica como coletamos, usamos, protegemos e divulgamos suas informações com base na Lei Geral de Proteção de Dados (LGPD).
          </p>
