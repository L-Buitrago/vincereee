    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24 md:px-8 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          ...
          <p>
            Bem-vindo ao site da Sovtre. Ao acessar ou usar nosso site ("Serviço"), você concorda em ficar vinculado a estes Termos de Uso. Leia-os atentamente.
          </p>
          ...
          <p>
            Todo o conteúdo presente no site, incluindo, mas não se limitando a, textos, gráficos, imagens, logotipos, ícones de botões e compilações de software, é propriedade exclusiva da Sovtre ou de seus fornecedores de conteúdo e protegido pelas leis de direitos autorais, marcas registradas e propriedades intelectuais aplicáveis no Brasil e internacionalmente.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">4. Isenção de Responsabilidade</h2>
          <p>
            O conteúdo do site é fornecido "no estado em que se encontra", sem quaisquer garantias expressas ou implícitas de qualquer espécie. A Sovtre não garante que o site funcionará ininterruptamente ou que estará livre de erros.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">5. Limitação de Responsabilidade</h2>
          <p>
            Em nenhuma hipótese a Sovtre será responsável por quaisquer danos diretos, indiretos, incidentais, especiais ou consequências sofridas em resultado do uso ou incapacidade de usar o nosso site.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">6. Links de Terceiros</h2>
          <p>
            Nosso Serviço pode conter links e redirecionamentos para sites de terceiros que não são controlados pela Sovtre. Não assumimos qualquer responsabilidade pelo conteúdo, políticas de privacidade ou práticas de qualquer site de terceiros.
          </p>
          ...
          <p>
            Estes Termos serão regidos e interpretados de acordo com a legislação da República Federativa do Brasil. Quaisquer disputas ou controvérsias decorrentes ou relacionadas a estes Termos ou ao uso do site serão submetidas ao foro da comarca da sede da Sovtre.
          </p>
        </div>
      </main>
      <Footer />
