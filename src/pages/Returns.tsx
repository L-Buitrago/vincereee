    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24 md:px-8 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          <p>
            Na Sovtre, buscamos garantir a total satisfação de nossos clientes com a máxima transparência e em consonância as exigências do Código de Defesa do Consumidor. Leia atentamente as regras para cancelamentos de serviços prestados ou devoluções e trocas.
          </p>
